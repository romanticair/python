"""
image viewer extension: users fixed-size thumbnail buttons for uniform layout, and
...
def viewer(imgdir, kind=Toplevel, numcols=None, height=300, width=300):
    ...
    fullsie = (0, 0,                                    # upper left X,Y
               linksize * numcols,
               linksize * numrows)                      # lower left X,Y
    canvas.config(scrollregion=fullsie)                 # scrollable area size
