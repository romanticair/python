...
# reuse book examples
from Gui.Tools import windows           # window border, exit protocols
from Gui.Tools import threadtools       # thread callback queue checker
from Internet.Email import mailtools    # load,send,parse,build utilities
from Gui.TextEditor import textEditor   # component and pop up
